    ...
    <>
      <div className="lg:pl-32 lg:pr-0 sm:px-8 px-4 ">
        ...
        <div className="flex justify-end lg:border-l-[1px] lg:border-r-0 border-x-[1px] border-b-[1px] border-[#D2D2D5]">
          <div className="lg:w-[55%] xl:p-12 lg:p-4 lg:text-left text-center">
            <h6 className="pt-10 text-[#52002D] lg:text-[28px] text-[24px] font-normal aeionik-font">
              We speak your language
            </h6>
            <h2 className="py-4 lg:px-0 px-4 text-[#000] lg:text-[56px] sm:text-[40px] text-[30px] font-normal sm:leading-[60px] leading-[36px] aeionik-font">
        ...
        {/* Expertise */}
        <div className="flex lg:flex-row flex-col justify-between lg:border-l-[1px] lg:border-r-0 border-x-[1px] border-b-[1px] border-[#D2D2D5] lg:px-12 md:py-14 py-8">
          <h4 className="text-[#52002D] 2xl:text-[28px] xl:text-[24px] text-[20px] font-normal aeionik-font py-2 lg:text-left text-center">
            Expertise
          </h4>
          <div className="lg:w-[55%] flex md:flex-row flex-col lg:justify-between justify-evenly xl:px-12 px-4 ">
        ...
        <div className="flex lg:flex-row flex-col justify-between lg:border-l-[1px] lg:border-r-0 border-x-[1px] border-b-[1px] border-[#D2D2D5] lg:px-12 md:py-14 py-8">
          ...
          <div className="lg:w-[55%] flex md:flex-row flex-col lg:justify-between justify-evenly xl:px-12 px-4 md:text-left text-center">
