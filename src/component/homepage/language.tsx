  ...
  return (
    <>
      <div className="lg:pl-32 lg:pr-0 sm:px-8 px-4 ">
        ...
        <div className="flex justify-end lg:border-l-[1px] lg:border-r-0 border-x-[1px] border-b-[1px] border-[#D2D2D5] lg:py-0 py-10">
          <div className="lg:w-[55%] xl:p-8 lg:p-4 lg:text-left text-center">
            <h6 className="lg:pt-48  text-[#52002D] lg:text-[28px] text-[24px] font-normal aeionik-font">
        ...
        <div className="flex lg:flex-row flex-col justify-between lg:border-l-[1px] lg:border-r-0 border-x-[1px] border-b-[1px] border-[#D2D2D5] lg:px-8 md:py-14 py-8">
          <h4 className="text-[#52002D] 2xl:text-[26px] xl:text-[22px] text-[20px] font-normal aeionik-font py-2 lg:text-left text-center">
            Expertise
          </h4>
          <div className="lg:w-[55%] flex md:flex-row flex-col lg:justify-between justify-evenly xl:px-8 px-4 ">
            <ul className="lg:w-[55%] md:w-[40%] w-full md:text-left text-center">
              <li className="text-[#000] 2xl:text-[26px] xl:text-[22px] text-[19px] font-normal aeionik-font py-2">
